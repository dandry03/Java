...
public class Pokerito {
    public static void main(String[] args) {
        ...
        */
        ...
        String compGuess = randomCard();

        System.out.println("Here's your card: " + playerCard + "\n");

        System.out.println("Here's the computer's card: " + compGuess);
    ...
    public static String randomCard() {
        ...
        double randomNumber = Math.random() * 13; //0 - 12.99
